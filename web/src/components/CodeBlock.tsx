...
export function CodeBox({ code, background }: codeBoxProps) {
    ...
    return (
        ...
        <div className="w-full h-full group flex flex-col"> 
            <div className={`sm:w-full relative w-full  scrollbar-track-[black] scrollbar-thumb-neutral-800 scrollbar-thin overflow-auto rounded-xl pt-3 pb-5 border border-white border-opacity-10 ${background}`}>
