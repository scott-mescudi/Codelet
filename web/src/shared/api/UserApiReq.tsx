...
export async function Signup(
  ...
  try {
    const resp = await fetch(
      "https://codeletserver-production.up.railway.app/api/v1/register",
      {
        method: "POST",
        headers: {
...
export async function Login(email: string, password: string): Promise<number> {
  ...
  try {
    const resp = await fetch(
      "https://codeletserver-production.up.railway.app/api/v1/login",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function Logout(token: string) {
  ...
  try {
    const resp = await fetch(
      `https://codeletserver-production.up.railway.app/api/v1/logout`,
      {
        method: "POST",
        headers: {
          Authorization: token,
...
export async function GetUsername(token: string): Promise<string | undefined> {
  ...
  try {
    const resp = await fetch(
      `https://codeletserver-production.up.railway.app/api/v1/username`,
      {
        method: "GET",
        headers: {
          Authorization: token,
